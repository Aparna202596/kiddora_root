...
def wishlist_view(request):
    ...
    for wi in items:
        ...
        available = (
            ...
            and product.subcategory.is_active
            and not product.subcategory.is_deleted
...
def wishlist_variant_popup(request, product_id):
    ...
    return render(
        request,
        "wishlist/wishlist_product_variant.html",
        {
            "product": product,
...
def move_to_cart(request, variant_id):
    ...
    try:
        ...
        print(
            f"[move_to_cart] ERROR for variant {variant_id}: {type(e).__name__} - {str(e)}"
        )
        import traceback
